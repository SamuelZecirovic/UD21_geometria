  ...
  //metodo area del cuadrado
    @Test
  	public void testareacuadrado(){
  		int resultado = G1.areacuadrado(4);
  		int esperado = 16;
    ...
    @Test
  	public void testareaCirculo(){
  		Double resultado = G1.areaCirculo(1);
    ...
    @Test
  	public void testareatriangulo(){
  		int resultado = G1.areatriangulo(4,4);
  		int esperado = 8;
  		assertEquals(esperado,resultado);
  		}
    ...
    @Test
  	public void testarearectangulo(){
  		int resultado = G1.arearectangulo(4,4);
  		int esperado = 16;
  		assertEquals(esperado,resultado);
  		}
    ...
    @Test
  	public void testareapentagono(){
  		int resultado = G1.areapentagono(4,4);
  		int esperado = 8;
  		assertEquals(esperado,resultado);
  		}
    ...
    @Test
  	public void testarearombo(){
  		int resultado = G1.arearombo(4,4);
  		int esperado = 8;
  		assertEquals(esperado,resultado);
  		}
    ...
    public void testMain() {
    	com.geometria.Junit09.App.main(null);
    }
